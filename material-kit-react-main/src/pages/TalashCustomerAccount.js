...
export default function CustomerAccount() {
  ...
  return (
    ...
    <Box  sx={{ 
        ...
        sx={{ mt:1, boxShadow: 3 ,borderRadius:1  }} inputProps={{style:{padding:"6px 10px", fontSize:"14px" , }}}  placeholder="Full Name"              
         />
        <TextField   color="warning"  
    ...
    <Grid item xs  direction="column" sx={{display:"flex" ,alignItems: "center", mt:4 ,mr: 15,}}>
      <div>
          <h3>
          Profile Pic
          </h3>
       ...
       <img 
       style={{width:"100%",heigth:"200px"}}  src="https://media.sproutsocial.com/uploads/2018/04/Facebook-Cover-Photo-Size.png" />
       ...
       <Box  sx={{ 
        ...
        <Box  sx={{ 
          ...
          <Button variant="contained"  sx={{backgroundColor:"#FFC619"}}> BusinessAccount </Button>
